...
func (m *Repository) AllBooksFilterFromReadList(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "public_books_from_readList.page.tmpl", &models.TemplateData{})
}
...
func (m *Repository) AllBooksFilterFromReadListApi(w http.ResponseWriter, r *http.Request) {
	...
	filteredBooks, err := m.DB.GetAllBooksFromReadListByUserId(limit, page, user_id, searchKey, sort)
	if err != nil {
